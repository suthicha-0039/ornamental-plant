...
const BASE_URL = "https://66a84f3953c13f22a3d24c9c.mockapi.io/products";
 ...
 return (
   ...
   <div className="flex min-h-screen flex-col items-center justify-between p-4">
     ...
     <div className="flex gap-2">
       ...
       {/* -------------------จบตะกร้าสินค้า--------------------------  */}
       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 rounded-lg mt-4 border-2 border-cyan-500">
